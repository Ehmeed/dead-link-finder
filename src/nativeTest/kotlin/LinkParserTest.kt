// i dont even care
actual val zahradnictviKarlovHtml: String = """
    <!doctype html>
    ...
    <p>
    	<h3>Od 23. prosince zavřeno</h3>
    	<h3>Otevřeno od března 2021</h3>
    	<h3> </h3>
    	<h3>  </h3> 
    ...
    <li>řezané a umělé květiny                <br>
    <li>substráty, kůru                       <br>
    <li>hnojiva, přípravky na ochranu rostlin    <br>
    <li>svíčky                                  <br>
